...
public class ImageInputHelper {
    ...
    private android.app.Fragment fragmentApp;
    ...
    public ImageInputHelper(android.app.Fragment fragment) {
    ...
    public void selectImageFromGallery() {
        ...
        } else if (fragmentApp != null) {
            fragmentApp.startActivityForResult(intent, REQUEST_PICTURE_FROM_GALLERY);
        }else {
    ...
    public void takePhotoWithCamera() {
        ...
        if (fragment != null) {
            ...
            fragmentApp.startActivityForResult(intent, REQUEST_PICTURE_FROM_CAMERA);
        } else {
    ...
    public void requestCropImage(Uri uri, int outputX, int outputY, int aspectX, int aspectY) {
        ...
        if (fragment != null) {
            ...
            fragmentApp.startActivityForResult(intent, REQUEST_CROP_PICTURE);
        } else {
